...
"}")
        ...
        self.avg_widget = QtWidgets.QWidget(self.centralwidget)
        self.avg_widget.setObjectName("avg_widget")
        self.verticalLayout_3.addWidget(self.avg_widget)
        ...
        self.verticalLayout_3.addWidget(self.history_widget)
